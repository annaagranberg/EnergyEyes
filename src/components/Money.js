...
function Money(value) {
  const images = [
    { src: img1, min: 0, max: 10, text: "Du sparar mycket pengar" },
    { src: img2, min: 10, max: 20, text: "Du sparar pengar" },
    { src: img3, min: 20, max: 30, text: "Tänk på ditt sparande" },
    { src: img4, min: 30, max: 40, text: "Du slösar pengar" },
    { src: img5, min: 40, max: 50, text: "Du kommer bli fattig" },
  ];
