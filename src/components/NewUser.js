...
export default function NewUser() {
  ...
  async function handleSubmit(e) {
    ...
    if (
      typeof firstRef.current.value !== "string" &&
      typeof lastRef.current.value !== "string"
    ) {
    ...
    try {
      ...
      await setNewUser(
        ...
        people,
        profil,
        duschAntal.current.value,
        duschTid.current.value,
        kok,
        disk,
        tvatt,
        dag.current.value,
  ...
  return (
    <>
      <ThemeProvider theme={theme}>
        <Card
          sx={{ minWidth: 270, mt: "10vh", ml: 1, mr: 1, mb: 0, pl: 2, pr: 2 }}
          elevation={0}
        >
          <CardContent>
            ...
            <Box
              component="div"
              sx={{ overflowX: "hidden", overflowY: "scroll", mb: 7 }}
            >
              <form onSubmit={handleSubmit}>
                ...
                <Box>
                  <Stack>
                    <FormLabel sx={{ mb: 1 }} required>
                      Hur ofta i veckan lagar du mat?
                    </FormLabel>
                    <Pagination
                      sx={{
                        ml: "auto",
                  ...
                  <Stack>
                    <FormLabel sx={{ mb: 1 }} required>
                      Hur många gånger i månaden tvättar du?
                    </FormLabel>
                    <Pagination
                      sx={{
                        ml: "auto",
